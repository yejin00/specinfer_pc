...
GGML_API void ggml_quantize_q4_0_reset_scale_stats(void);
GGML_API void ggml_quantize_q4_0_set_current_layer(int il);
...
GGML_API void dequantize_q4_0_pc(const void* src, float* dst, int n_dims, int n_tokens);
